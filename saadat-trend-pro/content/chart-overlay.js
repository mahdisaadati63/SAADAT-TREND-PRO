...
/**
 * Chart Overlay
 * مسئول رسم سیگنال‌ها (فلش‌ها و هایلایت‌ها) روی چارت مرورگر.
 */
...
class ChartOverlay {
    ...
    initContainer() {
        ...
        this.container.style.pointerEvents = 'none'; // تا مانع کلیک‌های کاربر نشود
    ...
    drawSignal(signal, position) {
        ...
        // فعلا به صورت دمو مقادیر ثابت می‌دهیم
